namespace Loupedeck.SketchPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SketchPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SketchPlugin.Resources.Resource.txt`.
